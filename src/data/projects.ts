...
export const projects: Project[] = [
  ...
  // ── 13. MINDWRITE (origin) ────────────────────────────────────────────────
  {
    slug: "mindwrite",
    title: "MindWrite",
    subtitle: "Where it started — journaling as a mission",
    summary:
      "The original journaling nonprofit initiative — business plan, mission, budget, and fundraising — that seeded the whole ecosystem.",
    category: "Nonprofit & Community",
    tags: ["Nonprofit", "Journaling", "Origin", "Strategy"],
    status: "archived",
    year: "2023",
    featured: false,
    accent: "#1D3557",
    role:
      "Founder and operator — I wrote the executive summary, business model canvas, mission, budget, and fundraising plan, drawing directly on my finance and nonprofit experience.",
    ...
    solution:
      "A journaling nonprofit with a full operating foundation — executive summary, business model canvas, mission and vision, budget, fundraising, marketing, and research.",
    features: [
    ...
    technology: ["Strategy", "Financial modeling", "Nonprofit operations"],
    process: "Built on real operational and finance experience — grant reporting, budgeting, and nonprofit advising.",
    lessons: "This is the origin of everything that followed — the through-line from finance and nonprofit work to AI-native product building.",
    futureVision: "Its spirit lives on in MindVault and the wider ecosystem.",
    links: [],
    relatedProjects: ["mindvault"],
    note: "The founding nonprofit initiative (circa 2023) — the origin story rather than an active product.",
  },
