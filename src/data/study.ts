...
export const backgroundQuestions: BackgroundQuestion[] = [
  ...
  { id: "bg_slavery_descent", q: "To your knowledge, are you descended from people who were brought to the Americas and enslaved during the transatlantic slave trade? (Family history or oral report is fine — documentation is not required.)", type: "single", options: ["Yes — ancestors enslaved in the United States", "Yes — ancestors enslaved elsewhere in the Americas", "No", "Unsure / I don't know"].map((l) => ({ id: l, label: l })).concat([PNA]) },
