...
export const ITEMS: StoreItem[] = [
  ...
  { id: "gucci", name: "$20K Gucci shopping spree", note: "No checking the price tags", detail: "Bags, shoes, jackets and accessories", category: "Luxury", price: 20_000, icon: "G", image: "/items/gucci-spree.png", featured: true },
  ...
  { id: "lamborghini", name: "Lamborghini Revuelto", note: "A 1,001-hp grocery getter", detail: "Illustrative out-the-door supercar price", category: "Luxury", price: 650_000, icon: "➜", image: "/items/lamborghini.png", featured: true },
  ...
  { id: "mansion", name: "Modern mega-mansion", note: "More bathrooms than friendships", detail: "A trophy property plus furnishing budget", category: "Luxury", price: 25_000_000, icon: "▥", image: "/items/mansion.png", featured: true },
